...
void LineEditHistory::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<LineEditHistory *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (LineEditHistory::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineEditHistory::searchNext)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (LineEditHistory::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineEditHistory::searchPrev)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (LineEditHistory::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineEditHistory::invalidate)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (LineEditHistory::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LineEditHistory::requestVisibleSymbols)) {
                *result = 3;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject LineEditHistory::staticMetaObject = { {
    &QLineEdit::staticMetaObject,
    qt_meta_stringdata_LineEditHistory.data,
    qt_meta_data_LineEditHistory,
    qt_static_metacall,
    nullptr,
    nullptr
} };
