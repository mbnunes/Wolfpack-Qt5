...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ProfileSessionModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ProfileSessionModel_t qt_meta_stringdata_ProfileSessionModel = {
    {
QT_MOC_LITERAL(0, 0, 19) // "ProfileSessionModel"
...
QT_INIT_METAOBJECT const QMetaObject ProfileSessionModel::staticMetaObject = { {
    &QAbstractItemModel::staticMetaObject,
    qt_meta_stringdata_ProfileSessionModel.data,
    qt_meta_data_ProfileSessionModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ProfileSessionModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ProfileSessionModel.stringdata0))
