...
#
# Host: localhost:3306
# Generation Time: Jun 12, 2003 at 04:44 PM
...
CREATE TABLE npcs (
  ...
  fleeat smallint(3) unsigned NOT NULL default '10',
  spellslow int(11) unsigned NOT NULL default '0',
  spellshigh int(11) unsigned NOT NULL default '0',
  PRIMARY KEY  (serial),
  UNIQUE KEY serial (serial)
