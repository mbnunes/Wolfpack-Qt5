...
void cUOSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        cUOSocket *_t = static_cast<cUOSocket *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            typedef void (cUOSocket::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&cUOSocket::disconnected)) {
                *result = 0;
            }
        }
    }
...
const QMetaObject cUOSocket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_cUOSocket.data,
      qt_meta_data_cUOSocket,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *cUOSocket::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_cUOSocket.stringdata0))
        return static_cast<void*>(const_cast< cUOSocket*>(this));
