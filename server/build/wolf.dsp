...
# ADD CPP /nologo /MDd /Gm /GR /GX /ZI /Od /I "lib/Python/PC" /I "lib/Python/include" /I "lib\bugreport" /I "lib\ZThread\include" /I "$(QTDIR)\include" /I "c:\mysql\include" /D "_CONSOLE" /D "_MBCS" /D "ZTHREAD_STATIC" /D "PY_NOSOCKETS" /D "_DEBUG" /D "WIN32" /D "QT_DLL" /D "QT_NO_STL" /FR /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib advapi32.lib ws2_32.lib ZThread.lib $(QTDIR)\lib\qt-mt312.lib libmysql.lib flatstore.libodbccp32.lib libmysql.lib flatstore.lib python22_d.lib /nologo /version:12.9 /subsystem:console /map /debug /machine:I386 /out:"C:\Wolfpack\Wolfpack.exe" /pdbtype:sept /libpath:"lib\ZThread\lib" /libpath:"lib\Python\lib" /libpath:"lib\bugreport\lib" /libpath:"flatstore\Debug"
# SUBTRACT LINK32 /pdb:none
