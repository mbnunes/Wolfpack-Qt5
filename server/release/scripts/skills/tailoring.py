...
LEATHERS = [
		[tr('Leather'),		TAILORING, 0, 	['leather_cut', 'leather_hides'], 				0x0,   'leather'],
		[tr('Spined Leather'), 	TAILORING, 650, ['spined_leather_cut', 'spined_leather_hides'], 0x283, 'spined_leather'],
		[tr('Horned Leather'), 	TAILORING, 800, ['horned_leather_cut', 'horned_leather_hides'], 0x227, 'horned_leather'],
		[tr('Barbed Leather'), 	TAILORING, 990, ['barbed_leather_cut', 'barbed_leather_hides'], 0x1c1, 'barbed_leather'],
]
