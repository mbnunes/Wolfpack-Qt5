...
EVENT_LOGOUT				= 9
EVENT_TALK					= 10
EVENT_WARMODETOGGLE			= 11
EVENT_HELP					= 12
EVENT_CHAT					= 13
EVENT_SKILLUSE				= 14
EVENT_SELECTCONTEXTMENU		= 15
EVENT_REQUESTCONTEXTMENU	= 16
EVENT_DROPONCHAR			= 17
EVENT_DROPONITEM			= 18
EVENT_DROPONGROUND			= 19
EVENT_PICKUP				= 20
EVENT_SPEECH				= 21
EVENT_BEGINCAST				= 22
EVENT_ENDCAST				= 23
EVENT_SPELLCHECKTARGET		= 24
EVENT_SPELLSUCCESS			= 25
EVENT_SPELLFAILURE			= 26
EVENT_SHOWTOOLTIP			= 27
EVENT_SKILLGAIN				= 28
EVENT_DAMAGE				= 29
EVENT_SHOWPAPERDOLL			= 30
EVENT_SHOWSKILLGUMP			= 31
EVENT_STATGAIN				= 32
EVENT_CASTSPELL				= 33
EVENT_CHLEVELCHANGE			= 34
