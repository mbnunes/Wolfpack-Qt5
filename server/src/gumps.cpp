		...
		{ 
			...
			case 204:
				...
				else
				{
					...
					//cNetwork::instance()->Disconnect(calcSocketFromChar(pc_c));
					break;
				}
			default:
	...
	case 5:           // House
		{
			...
			case 3:  // Turn house into a deed
				dynamic_cast< cHouse* >(pj)->toDeed( s );
				return;
...
void cGump::addGump( Q_INT32 gumpX, Q_INT32 gumpY, Q_UINT16 gumpId, Q_INT16 hue = -1 ) 
{
