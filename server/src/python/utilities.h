...
#define getArgStr( id ) PyString_Check(PyTuple_GetItem(args,id)) ? PyString_AsString(PyTuple_GetItem(args, id)) : QString::fromUcs2(PyUnicode_AS_UNICODE(PyTuple_GetItem(args,id)))
