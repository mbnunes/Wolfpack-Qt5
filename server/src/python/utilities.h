...
#define checkArgInt( id ) ( PyTuple_Size( args ) > id && PyLong_Check( PyTuple_GetItem( args, id ) ) )
#define getArgInt( id ) PyLong_AsLong( PyTuple_GetItem( args, id ) )
#define checkArgStr( id ) ( PyTuple_Size( args ) > id && ( PyUnicode_Check( PyTuple_GetItem( args, id ) ) || PyUnicode_Check( PyTuple_GetItem( args, id ) ) ) )
