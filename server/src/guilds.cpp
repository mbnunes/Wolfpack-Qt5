...
void cGuilds::save()
{
	...
	PersistentBroker::instance()->truncateTable( "guilds" );
	PersistentBroker::instance()->truncateTable( "guilds_members" );
	PersistentBroker::instance()->truncateTable( "guilds_canidates" );
	PersistentBroker::instance()->truncateTable( "guilds_allies" );
	PersistentBroker::instance()->truncateTable( "guilds_enemies" );
