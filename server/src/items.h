...
//***************************END ADDED GETTERS************
	...
	void	setAmount2( ushort nValue ) { amount2_ = nValue; changed_ = true;}; //Used to track things like number of yards left in a roll of cloth
	...
	void	setMoreb1( uchar nValue ) { moreb1_ = nValue; changed_ = true;};
	void	setMoreb2( uchar nValue ) { moreb2_ = nValue; changed_ = true;};
	void	setMoreb3( uchar nValue ) { moreb3_ = nValue; changed_ = true;};
	void	setMoreb4( uchar nValue ) { moreb4_ = nValue; changed_ = true;};
...
//*****************************************ADDED SETTERS ***************
	...
	void	setDef( uint data ) { def_ = data; changed_ = true;}
	void	setSt( short data ) { st_ = data; changed_ = true;}
	void	setSt2( short data ) { st2_ = data; changed_ = true;}
	void	setDx( short data ) { dx_ = data; changed_ = true;}
	void	setDx2( short data ) { dx2_ = data; changed_ = true;}
	void	setIn( short data ) { in_ = data; changed_ = true;}
	void	setIn2( short data ) { in2_ = data; changed_ = true;}
	void	setMagic( uchar data ) { magic_ = data; changed_ = true;}
	...
	void	setPrice( int data ) { price_ = data; changed_ = true;}
	void	setBuyprice( int data ) { buyprice_ = data; changed_ = true;}
