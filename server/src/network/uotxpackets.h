...
public:
	...
	void setReason( eDenyLogin data )
	{
		( *this )[1] = data;
	}
};
...
public:
	...
	void setServerIp( unsigned int data )
	{
		setInt( 1, data );
	}
	...
	void setAuthId( unsigned int authId )
	{
		setInt( 7, authId );
	}
};
...
public:
	...
	void setResult( eCharChangeResult data )
	{
		( *this )[1] = data;
	}
};
...
public:
	...
	void setMap( unsigned char data )
	{
		( *this )[5] = data;
	}
};
...
public:
	...
	void setType( eWeatherType data )
	{
		( *this )[1] = data;
	}
	void setAmount( unsigned char data )
	{
		( *this )[2] = data;
	}
	void setTemperature( unsigned char data )
	{
		( *this )[3] = data;
	}
};
...
public:
	...
	void setUnknown1( unsigned char data )
	{
		( *this )[7] = data;
	}
...
public:
	...
	void setRejectType( eRejectType type )
	{
		( *this )[1] = type;
	}
};
...
public:
	...
	void setWearer( unsigned int serial )
	{
		setInt( 9, serial );
	}
	void setColor( unsigned short data )
...
public:
	...
	void setAttacker( unsigned int data )
	{
		setInt( 2, data );
	}
	void setVictim( unsigned int data )
	{
		setInt( 6, data );
	}
};
...
public:
	...
	void setRealValue( unsigned short data )
	{
		setShort( 8, data );
	}
	void setStatus( eStatus data )
	{
		( *this )[10] = data;
	}
	void setCap( unsigned short data )
	{
		setShort( 11, data );
	}
};
...
public:
	...
	void setSkin( unsigned short data )
	{
		setShort( 8, data );
	}
	void setFlag( unsigned char data )
	{
		( *this )[10] = data;
	} // // 10 = 0=normal, 4=poison, 0x40=attack, 0x80=hidden CHARMODE_WAR
...
public:
	...
	void setBoundX( unsigned short data )
	{
		setShort( 8, data );
	}
	void setBoundY( unsigned short data )
	{
		setShort( 10, data );
	}
	void setWidth( unsigned short data )
	{
		setShort( 12, data );
	}
	void setHeight( unsigned short data )
	{
		setShort( 14, data );
	}
};
...
public:
	...
	void setModel( unsigned short data )
	{
		setShort( 7, data );
	}
	void setX( unsigned short data )
...
{
public:
	cUOTxOptions() : cUOPacket( 0x69, 5 )
	{
		setShort( 1, 5 );
	}
	void setOption( unsigned char data )
	{
		( *this )[3] = data;
	}
};
...
{
public:
	cUOTxUnicodeSpeech() : cUOPacket( 0xAE, 50 )
	{
		setShort( 1, 50 );
	}
	...
	void setFont( unsigned short font )
	{
		setShort( 12, font );
	}
...
{
public:
	cUOTxSendStats() : cUOPacket( 0x11, 0x2B )
	{
		setShort( 1, 0x2B );
	}
	...
	void setDexterity( unsigned short data )
	{
		setShort( 46, data );
	}
	void setIntelligence( unsigned short data )
	{
		setShort( 48, data );
	}
	void setStamina( unsigned short data )
	{
		setShort( 50, data );
	}
	void setMaxStamina( unsigned short data )
	{
		setShort( 52, data );
	}
	void setMana( unsigned short data )
	{
		setShort( 54, data );
	}
	void setMaxMana( unsigned short data )
	{
		setShort( 56, data );
	}
	void setGold( unsigned int data )
	{
		setInt( 58, data );
	}
	void setArmor( unsigned short data )
	{
		setShort( 62, data );
	}
	void setWeight( unsigned short data )
	{
		setShort( 64, data );
	}
	// extended for newer clients
	void setStatCap( unsigned short data )
	{
		setShort( 66, data );
	}
	void setPets( unsigned char data )
	{
		( *this )[68] = data;
	}
	void setMaxPets( unsigned char data )
	{
		( *this )[69] = data;
	}
};
...
public:
	...
	void setEntNum( unsigned char data )
	{
		( *this )[11] = data;
	}
...
public:
	...
	void setDamage( unsigned char data )
	{
		( *this )[10] = data;
	}
};
...
public:
	...
	void setSequence( unsigned char data )
	{
		( *this )[1] = data;
	}
...
{
public:
	cUOTxSendItem() : cUOPacket( 0x1A, 20 )
	{
		setShort( 1, 20 );
	}
	void setSerial( unsigned int data )
	{
		setInt( 3, data | 0x80000000 );
	}
	void setId( unsigned short data )
	{
		setShort( 7, data );
	}
	void setAmount( unsigned short data )
	{
		setShort( 9, data );
	}
	void setCoord( const Coord_cl& coord );
...
public:
	...
	void setAllowGround( bool data )
	{
		( *this )[1] = data ? 1 : 0;
	}
	void setTargSerial( unsigned int data )
	{
		setInt( 2, data );
	}
};
...
public:
	...
	void setModelID( unsigned short data )
	{
		setShort( 18, data );
	}
};
...
{
public:
	cUOTxSoundEffect() : cUOPacket( 0x54, 12 )
	{
		( *this )[1] = 1;
	}
	void setSound( unsigned short data )
	{
		setShort( 2, data );
	}
	void setUnknown( unsigned short data )
	{
		setShort( 4, data );
	}
	void setCoord( const Coord_cl& coord );
...
public:
	...
	void setReason( eBounceReason reason )
	{
		( *this )[1] = reason;
	}
};
...
public:
	...
	void setMaximum( unsigned short data )
	{
		setShort( 5, data );
	}
	void setCurrent( unsigned short data )
	{
		setShort( 7, data );
	}
};
...
public:
	...
	void setAction( unsigned short data )
	{
		setShort( 5, data );
	}
	void setUnknown1( unsigned char data )
	...
	void setRepeat( unsigned short data )
	{
		setShort( 9, data );
	}
	void setBackwards( unsigned char data )
	{
		( *this )[11] = data;
	}
	void setRepeatFlag( unsigned char data )
	{
		( *this )[12] = data;
	}
	void setSpeed( unsigned char data )
	{
		( *this )[13] = data;
	}
};
...
public:
	...
	void setCorpse( unsigned int data )
	{
		setInt( 5, data );
	}
	void setUnknown1( unsigned int data )
...
{
public:
	cUOTxClearBuy() : cUOPacket( 0x3B, 8 )
	{
		setShort( 1, 8 );
	}
	void setSerial( unsigned int data )
...
public:
	...
	void setActive( unsigned char status )
	{
		( *this )[1] = status;
	}
...
{
public:
	cUOTxCorpseEquipment() : cUOPacket( 0x89, 8 )
	{
		setShort( 1, 8 );
	}
...
{
public:
	cUOTxItemContent() : cUOPacket( 0x3C, 5 )
	{
		setShort( 1, 5 );
	}
...
{
public:
	cUOTxVendorBuy() : cUOPacket( 0x74, 8 )
	{
		setShort( 1, 8 );
	}
	void setSerial( unsigned int data )
...
public:
	...
	void setType( unsigned int data )
	{
		setInt( 7, data );
	}
	void setX( int data )
...
public:
	...
	void setDuration( unsigned char data )
	{
		( *this )[23] = data;
	}
	void setUnknown( unsigned short data )
	...
	void setFixedDirection( bool data )
	{
		( *this )[26] = data ? 1 : 0;
	}
	void setExplodes( bool data )
	{
		( *this )[27] = data ? 1 : 0;
	}
};
...
{
public:
	cUOTxCloseGump() : cUOPacket( 0xBF, 13 )
	{
		setShort( 1, 13 ); setShort( 3, 0x04 );
	}
	void setType( SERIAL data )
	{
		setInt( 5, data );
	}
	void setButton( unsigned int data )
	{
		setInt( 9, data );
	}
};
...
{
public:
	cUOTxNewSpellbook() : cUOPacket( 0xBF, 0x17 )
	{
		setShort( 1, 0x17 ); setShort( 3, 0x1b ); setShort( 5, 1 ); setShort( 13, 1 );
	}
	void setBook( SERIAL data )
	{
		setInt( 7, data );
	}
	void setModel( unsigned short data )
	...
	void setOffset( unsigned short data )
	{
		setShort( 13, data );
	}
	void setSpell1( unsigned int data )
	{
		setInt( 15, data );
	}
	void setSpell2( unsigned int data )
	{
		setInt( 19, data );
	}
};
...
{
public:
	cUOTxTrade() : cUOPacket( 0x6f, 17 )
	{
		setShort( 1, 17 );
	}
	void setName( const QString& name );
	void setPartner( SERIAL data )
	{
		setInt( 4, data );
	}
	void setBox1( SERIAL data )
	{
		setInt( 8, data );
	}
	void setBox2( SERIAL data )
	{
		setInt( 12, data );
	}
	void setAction( unsigned char data )
	{
		( *this )[3] = data;
	}
};
...
{
public:
	cUOTxClilocMsg() : cUOPacket( 0xC1, PacketLen )
	{
		setShort( 1, PacketLen );
	}
	...
	void setMsgNum( unsigned int data )
	{
		setInt( 14, data );
	}
	void setName( const QString& data )
...
{
public:
	cUOTxClilocMsgAffix() : cUOPacket( 0xCC, PacketLen )
	{
		setShort( 1, PacketLen );
	}
...
public:
	...
	void setHue( unsigned int data )
	{
		setInt( 28, data );
	}
	void setRenderMode( unsigned int data )
	{
		setInt( 32, data );
	}
};
...
public:
	...
	// 3d Specific Stuff
	void set3dEffectId( unsigned short data )
	{
		setShort( 36, data );
	}
	void set3dExplosionId( unsigned short data )
	{
		setShort( 38, data );
	}
	void set3dAdditionalId( unsigned short data )
	{
		setShort( 40, data );
	}
	void set3dSource( SERIAL data )
	{
		setInt( 42, data );
	}
	void set3dSourceLayer( unsigned char data )
	{
		( *this )[46] = data;
	}
	void set3dAdditional2Id( unsigned short data )
	{
		setShort( 47, data );
	}
};
...
public:
	...
	void setLevel( unsigned char data )
	{
		( *this )[5] = data;
	}
};
...
public:
	...
	void setReason( enReason reason )
	{
		( *this )[1] = ( unsigned char ) reason;
	}
};
...
{
public:
	cUOTxProfile() : cUOPacket( 0xB8, 12 )
	{
		setShort( 1, 12 );
	}
	void setSerial( unsigned int data )
...
{
public:
	cUOTxItemTarget() : cUOPacket( 0xb4, 16 )
	{
		setShort( 1, 16 );
	}
	...
	void setXOffset( short data )
	{
		setShort( 8, data );
	}
	void setYOffset( short data )
	{
		setShort( 10, data );
	}
	void setZOffset( short data )
	{
		setShort( 12, data );
	}
...
public:
	...
	void setUnknown3( unsigned char data )
	{
		( *this )[10] = data;
	}
	void setSerial( unsigned int data )
...
public:
	...
	void setCompression( unsigned char data )
	{
		( *this )[3] = data;
	}
	void setSerial( unsigned int data )
	...
	void setRevision( unsigned int data )
	{
		setInt( 9, data );
	}
...
{
public:
	cUOTxSellList() : cUOPacket( 0x9E, 9 )
	{
		setShort( 1, 9 );
	}
	void setSerial( unsigned int data )
