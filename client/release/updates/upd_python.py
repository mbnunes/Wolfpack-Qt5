...
FILENAMES = ("python24.dll", "scripts/encodings/__init__.pyo", "scripts/encodings/aliases.pyo", "scripts/codecs.pyo", "scripts/copy_reg.pyo", "scripts/encodings/cp1252.pyo", "scripts/linecache.pyo", "scripts/locale.pyo", "scripts/ntpath.pyo", "scripts/os.pyo", "scripts/site.pyo", "scripts/stat.pyo", "scripts/types.pyo", "scripts/UserDict.pyo", "scripts/warnings.pyo")
ARCHIVE = 'updates\\python.7z'
SOURCEPATH = "../"
